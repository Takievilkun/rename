...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/Anime_Hindi_Dub_Official'),
      InlineKeyboardButton('💬 Support', url='https://t.me/Dynamite_Animes_Hindi_Dubbed')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/Takievil')
    ]])
    if Config.START_PIC:
